...
function addName(flibbitygibbet){
    fullName4.push(`${flibbitygibbet.first_name} ${flibbitygibbet.last_name}`)
}
...
let allCaps = [];
runners.map(allCapMode)

function allCapMode (wubba) {
    allCaps.push(`${wubba.first_name}`)
}

let allCaps2 = allCaps.toString()
let allCaps3 = allCaps2.toUpperCase()

console.log(allCaps3);
